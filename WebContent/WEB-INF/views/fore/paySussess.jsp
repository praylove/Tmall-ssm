...
<div class="g-mid" style="border: 1px solid #CCCCCC;">
			...
			<div class="m-success-details">
				<ul>
					...
					<li>实付款：￥ <fmt:formatNumber value="${total}" pattern="#,#00.00#" /></li>
					<li>预计<fmt:formatDate type="date" value="${time}" />送达</li>
				</ul>
				<div>
					您可以 <a href="../s-order/list" class="link">查看已买到的宝贝 </a><a href="forelistOrder" class="link"> 查看交易详情</a>
				</div>
			</div>
			<div class="m-success-underline"></div>
			<div class="m-success-warning">
				<img src="image/site/warning.png" alt="warning" />
